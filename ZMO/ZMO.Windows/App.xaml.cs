...
namespace ZMO
{
    ...
    public sealed partial class App : Application
    {
        ...
        private async void suppport()
        {
            try
            {
                await Windows.System.Launcher.LaunchUriAsync(new Uri("mailto:dev@eynorey.com"));
            }
            catch { }
        }
        private void semester()
        {
            ApplicationData.Current.RoamingSettings.Values["TopBar"] = "1";
            (Window.Current.Content as Frame).Navigate(typeof(MainPage));
        }
        private async void windowsphone()
        {
            try
            {
                await Windows.System.Launcher.LaunchUriAsync(new Uri("http://www.windowsphone.com/de-de/store/app/zensuren-manager-oberstufe/6d7b6663-d912-47ae-aa9b-8da310813dfc"));
            }
            catch { }
        }
    }
